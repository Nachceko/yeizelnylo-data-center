...
export default defineThemeConfig({
  logo: 'https://avatars.githubusercontent.com/u/172878250?v=4',

  appearance: true,  // 配置 深色模式

  social: [
    { icon: 'github', link: 'https://github.com/Nachceko/yeizelnylo-data-center' },
  ],
  ...
  profile: {
    ...
    name: 'YeizelNylo',
    description: '1つの熱愛の2次元の小さい萌の新しい~ /.こんにちはnya~です',
    // circle: true,
    // location: '',
    // organization: '',
  },
